...
"""
Sublate by jontaydev
Source: https://github.com/jontaydev/sublate
"""
...
def build_dst_directory(path, data, loaders):
    ...
    for filename in os.listdir(path):
        ...
        if "exclude" in data.get("sublate") and filename in data["sublate"]["exclude"]:
            continue
...
def main():
    ...
    parser.add_argument('src', metavar='N', type=str, nargs='?', default='.', help='src path')
    parser.add_argument('--dst', type=str, help='dst path', default='build')
